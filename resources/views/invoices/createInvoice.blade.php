...
@section('contenido')
    ...
    <div class="container-fluid"><h3 class="text-dark mb-4">Nuevo Invoice</h3>
        <div class="card shadow">
            <div class="card-header py-3"><p class="text-primary m-0 fw-bold">Invoice</p></div>
            <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="invoice-details">
                                <h2 style="font-size: 20px"><p id="nombre_compania" class="editable"
                                                               ondblclick="makeEditable('nombre_compania', 'Nombre de la Compañía')">
                                        Nombre de la Compañía</p></h2>
                                <h6 style="font-size:14px;color:#757575;"><p id="url_sitio_web" class="editable"
                                                                             ondblclick="makeEditable('url_sitio_web', 'URL del Sitio: www.tuempresa.com')">
                                        URL del Sitio: www.tuempresa.com</p></h6>
                                <h6 style="font-size:14px;color:#757575;"><p id="numero_compania" class="editable"
                                                                             ondblclick="makeEditable('numero_compania', 'Número de Teléfono: 123-456-789')">
                                        Número de Teléfono: 123-456-789</p></h6>
                                <h6 style="font-size:14px;color:#757575;"><p id="direccion" class="editable"
                                                                             ondblclick="makeEditable('direccion', 'Dirección: Dirección de la Compañía')">
                                        Dirección: Dirección de la Compañía</p></h6>
                                <h6 style="font-size:14px;color:#757575;"><p id="correo_electronico" class="editable"
                                                                             ondblclick="makeEditable('correo_electronico', 'Correo: info@tuempresa.com')">
                                        Correo: info@tuempresa.com</p></h6>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="invoice-details">
                                <h2 style="font-size: 20px"><p id="nombre_cliente" class="editable"
                                                               ondblclick="makeEditable('nombre_cliente', 'Nombre del Cliente')">
                                        Nombre del Cliente</p></h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p id="numero_factura" class="editable"
                                           ondblclick="makeEditable('numero_factura', 'Número de Factura: ###')">###</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p id="subtotal_factura" class="editable">0.00</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <p id="impuesto_factura" class="editable">0.00</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <p id="total_factura" class="editable">0.00</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-6">
                        <a type="button" class="btn btn-success mt-2" onclick="saveInvoice()">Guardar</a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Guardar Invoice?</h1>
                ...
                <div class="modal-footer">
                    ...
                    <a type="button" onclick="sendInvoice()" class="btn btn-primary">Si, Guardar Invoice</a>
                </div>
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script>
        ...
        function addInvoiceItem() {
            table.row.add(['Nuevo Producto', '1', '0.00', '<button class="btn btn-danger" onclick="removeInvoiceItem(this)">Eliminar</button>']).draw();
        }
        ...
        function calcular() {
            ...
            for (var i = 0; i < datosTabla.length; i++) {
                var cantidad = datosTabla[i][1];
                var totalProducto = datosTabla[i][2];
        ...
        function sendInvoice() {
            ...
            for (var i = 0; i < datosTabla.length; i++) {
                datosTablaArreglo.push({
                    'nombre_producto': datosTabla[i][0],
                    'cantidad': datosTabla[i][1],
                    'precio': datosTabla[i][2],
                });
            }
